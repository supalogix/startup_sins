...
\begin{figure}[H]
  ...
  \begin{tikzpicture}
    \comicpanel{0}{0}
      {The Recruit}
      {The Advisor}
      {Because trust is a ladder.\ And some of us prefer the climb.}
      {(0.6,-0.6)}
  \end{tikzpicture}
  \caption*{The Littlefinger doctrine.}
  \end{subfigure}
  \hfill
  \begin{subfigure}[t]{0.45\textwidth}
  \centering
  \begin{tikzpicture}
    \comicpanel{0}{0}
      ...
      {(-0.6,-0.6)}
  \end{tikzpicture}
  \caption*{The correct response.}
  \end{subfigure}

  \caption*{\textbf{Onboarding Strategy:} Every warning is also a rehearsal.}
\end{figure}
