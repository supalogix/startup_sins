...
\begin{TechnicalSidebar}{What is Synthetic Credit?}
  ...
  \begin{figure}[H]
    ...
    \resizebox{0.92\textwidth}{!}{%
      ...
      \draw[arrow] (trsparty) -- node[below] {\scriptsize Fixed/Floating Payment} (trsasset);
      ...
      \draw[arrow] (issuer) -- node[below] {\scriptsize Structured Payoff (linked to credit basket)} (investor);
  
  
      % Borrower arrow
      \draw[arrow, dashed] (borrower) -- node[below left] {\scriptsize Underlying risk flows} (trsasset);
      \draw[arrow, dashed] (borrower) -- node[below right] {} (issuer);
