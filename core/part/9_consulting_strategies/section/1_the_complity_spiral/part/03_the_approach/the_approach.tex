...
\begin{figure}[H]
    ...
    % Title
    \node[font=\bfseries] at (5.5,-0.8) {Liability Perimeter Design};
    ...
    \node[draw, thick, rounded corners, fill=white, minimum width=3.8cm, minimum height=1.2cm, align=center] 
      (centauri) at (3.3,-2.0) {Centauri\\ \scriptsize(Client-facing ops)};
    
    \node[draw, thick, rounded corners, fill=white, minimum width=3.8cm, minimum height=1.2cm, align=center] 
      (aurora) at (7.7,-2.0) {Aurora\\ \scriptsize(Infrastructure + ML)};
    ...
    % Annotation above LLC
    \node[txt, align=center] at (5.5,-1.2) {\textit{Liability sandbox:} \\
      Compartmentalizes exposure};
