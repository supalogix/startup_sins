...
\begin{document}
  ...
  This book, and the Startup Sins series as a whole, is officially an entirely imaginary work 
  constructed from hypothetical observations, apocryphal anecdotes, and several long evenings of 
  ...
  \begin{flushright}
  \textit{— Yours from the edge of the org chart}
  \end{flushright}

  \section*{This Is Fiction (Unless It Isn’t): About the Series}

  The book you're holding is part of a larger, ongoing experiment in narrative disclosure.  
  ...
  What you see in the comics, in the case studies, in the layered nods to \textit{The 48 Laws of Power} and its spiritual children — this isn’t a caricature of startup life.  
  It’s a language many of us learned to speak fluently, without realizing it was erasing us at the same time.
  ...
  I hated it because it was too painfully good. 
  
  I couldn’t get through more than two episodes without pausing to whisper, 
  \textit{``I was in that meeting.''}
  
  The writers didn’t invent satire.
  They just opened my old inbox and changed the names.
